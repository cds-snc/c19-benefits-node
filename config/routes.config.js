...
const routes = [
  ...
  { name: 'question-eligible-for-ei', path: { en: '/question/eligible-for-ei', fr: '/question/eligible-for-ei' } },
  { name: 'question-sick-or-quarantine', path: { en: '/question/sick-or-quarantine', fr: '/question/sick-or-quarantine' } },
  { name: 'question-leave-voluntarily', path: { en: '/question/leave-voluntarily', fr: '/question/leave-voluntarily' } },
  { name: 'result-cerb', path: { en: '/result/cerb', fr: '/result/cerb' } },
  { name: 'result-ei-regular', path: { en: '/result/ei-regular', fr: '/result/ei-regular' } },
